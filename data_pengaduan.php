...
<body class="bg-light">
    <div class="vh-100 justify-content-center row align-content-center">
        <form action="#" method="post" class="col-md-8 bg-white border rounded-4 p-3 shadow-sm">
            <h3 class="text-center"><data value=""></data>data Pengaduan</h3>
...
<tr class="fw-bold">
        ...
        kategori input_aspirasi.id_kategori = kategori.id_kategori AND
        aspirasi aspirasi.id_pelaporan = input_aspirasi.id_pelaporan AND
